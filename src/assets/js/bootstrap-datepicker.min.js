          ...
          [
            a(document),
            {
              mousedown: a.proxy(function (b) {
                this.element.is(b.target) ||
                  this.element.find(b.target).length ||
                  this.picker.is(b.target) ||
                  this.picker.find(b.target).length ||
                  a(this.picker).hide();
              }, this),
            },
          ],
      ...
      if (!isNaN(f) && !isNaN(g)) {
        ...
        for (var s, t = []; n.valueOf() < r; ) {
          if (
            ...
            var u = new Date(
                +n + ((this.o.weekStart - n.getUTCDay() - 7) % 7) * 864e5
              ),
