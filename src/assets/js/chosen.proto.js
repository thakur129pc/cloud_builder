    ...
    SelectParser.prototype.get_template_data = function (option) {
      ...
      for (k in _ref) {
        ...
        if (typeof v.nodeName === 'string') {
          ...
          if (
            attribute_name[0] === 'data' &&
            (attribute_name = attribute_name.slice(1))
          ) {
            for (
              i = _i = 0, _len = attribute_name.length;
              _i < _len;
              i = ++_i
            ) {
  ...
  Chosen = (function (_super) {
    ...
    Chosen.prototype.set_default_values = function () {
      ...
      this.single_temp = new Template(
        '<a href="javascript:void(0)" class="chzn-single chzn-default" tabindex="-1"><span>#{default}</span><div><b></b></div></a><div class="chzn-drop" style="left:-9000px;"><div class="chzn-search"><input type="text" autocomplete="off" /></div><ul class="chzn-results"></ul></div>'
      );
      this.multi_temp = new Template(
        '<ul class="chzn-choices"><li class="search-field"><input type="text" value="#{default}" class="default" autocomplete="off" style="width:25px;" /></li></ul><div class="chzn-drop" style="left:-9000px;"><ul class="chzn-results"></ul></div>'
      );
      this.choice_temp = new Template(
        '<li class="search-choice" id="#{id}"><span>#{choice}</span><a href="javascript:void(0)" class="search-choice-close" rel="#{position}"></a></li>'
      );
      this.choice_noclose_temp = new Template(
        '<li class="search-choice search-choice-disabled" id="#{id}"><span>#{choice}</span></li>'
      );
    ...
    Chosen.prototype.set_up_html = function () {
      var base_template,
        ...
        sf_width;
      this.container_id =
        this.form_field.identify().replace(/[^\w]/g, '_') + '_chzn';
      ...
      this.f_width = this.form_field.getStyle('width')
        ? parseInt(this.form_field.getStyle('width'), 10)
      ...
      base_template = this.is_multiple
    ...
    Chosen.prototype.container_mousedown = function (evt) {
      ...
      if (!this.is_disabled) {
        target_closelink =
          evt != null ? evt.target.hasClassName('search-choice-close') : false;
    ...
    Chosen.prototype.blur_test = function (evt) {
      if (
        !this.active_field &&
        this.container.hasClassName('chzn-container-active')
      ) {
        return this.close_field();
      }
    };
    ...
    Chosen.prototype.results_build = function () {
      ...
      if (this.is_multiple && this.choices > 0) {
        ...
        this.selected_item
          .addClassName('chzn-default')
          .down('span')
          .update(this.default_text);
        if (
          this.disable_search ||
    ...
    Chosen.prototype.choices_click = function (evt) {
      ...
      if (
        this.active_field &&
        !(
          evt.target.hasClassName('search-choice') ||
          evt.target.up('.search-choice')
        ) &&
    ...
    Chosen.prototype.result_select = function (evt) {
      ...
      if (this.result_highlight) {
        ...
        if (this.is_multiple) {
          ...
          this.search_results
            .descendants('.result-selected')
            .invoke('removeClassName', 'result-selected');
        ...
        if (this.is_multiple) {
          ...
          html = this.useTemplate(item);
          this.selected_item.down('span').update(html);
          if (this.allow_single_deselect) {
            this.single_deselect_control_build();
          }
        }
        ...
        if (
          ...
          (this.is_multiple || this.form_field.value !== this.current_value)
        ) {
          this.form_field.simulate('change');
        }
        this.current_value = this.form_field.value;
    ...
    Chosen.prototype.result_deselect = function (pos) {
      ...
      if (!this.form_field.options[result_data.options_index].disabled) {
        ...
        result
          .removeClassName('result-selected')
          .addClassName('active-result')
          .show();
        this.result_clear_highlight();
        this.winnow_results();
        if (typeof Event.simulate === 'function') {
    ...
    Chosen.prototype.winnow_results = function () {
      ...
      searchText =
        this.search_field.value === this.default_text
          ? ''
          : this.search_field.value.strip().escapeHTML();
        ...
        if (!option.disabled && !option.empty) {
          if (option.group) {
            ...
            if (found) {
              ...
              if ($(result_id).innerHTML !== html) {
                $(result_id).update(html);
              }
    ...
    Chosen.prototype.no_results = function (terms) {
      return this.search_results.insert(
