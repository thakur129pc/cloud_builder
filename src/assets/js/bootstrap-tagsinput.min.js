  ...
  !(function (t) {
    ...
    function e(e, n) {
      (this.itemsArray = []),
        ...
        (this.placeholderText = e.hasAttribute('placeholder')
      ...
      (this.$input.get(0).style.cssText = 'width: ' + i + ' !important;'),
        this.build(n);
    }
    function n(t, e) {
    ...
    (e.prototype = {
      ...
      add: function (e, n) {
        ...
        if (
          ...
          if (
            ('string' == typeof e && i.options.trimValue && (e = t.trim(e)),
            'object' == typeof e && !i.objectItems)
          )
          ...
          if (!e.toString().match(/^\s*$/)) {
            ...
            if (!p || i.options.allowDuplicates) {
              if (
                !(
                  i.items().toString().length + e.length + 1 >
                  i.options.maxInputLength
                )
              ) {
                var c = t.Event('beforeItemAdd', { item: e, cancel: !1 });
                if ((i.$element.trigger(c), !c.cancel)) {
                  ...
                  if (
                    ...
                    i.isSelect &&
                      !t(
                        'option[value="' + encodeURIComponent(s) + '"]',
                        i.$element
                      )[0])
                  ) {
                  ...
                  n || i.pushVal(),
                    (i.options.maxTags === i.itemsArray.length ||
                      i.items().toString().length ===
                        i.options.maxInputLength) &&
                      i.$container.addClass('bootstrap-tagsinput-max'),
                    i.$element.trigger(t.Event('itemAdded', { item: e }));
                }
              }
      ...
      remove: function (e, n) {
        ...
        if (
          ...
          var a = t.Event('beforeItemRemove', { item: e, cancel: !1 });
          ...
          t('.tag', i.$container)
            ...
            t('option', i.$element)
              ...
              .remove(),
            -1 !== t.inArray(e, i.itemsArray) &&
              i.itemsArray.splice(t.inArray(e, i.itemsArray), 1);
        }
        n || i.pushVal(),
          i.options.maxTags > i.itemsArray.length &&
            i.$container.removeClass('bootstrap-tagsinput-max'),
          i.$element.trigger(t.Event('itemRemoved', { item: e }));
      },
      removeAll: function () {
        var e = this;
        for (
          t('.tag', e.$container).remove(), t('option', e.$element).remove();
          e.itemsArray.length > 0;
      ...
      build: function (e) {
        var a = this;
        if (
          ((a.options = t.extend({}, s, e)),
          a.objectItems && (a.options.freeInput = !1),
          n(a.options, 'itemValue'),
          n(a.options, 'itemText'),
          i(a.options, 'tagClass'),
          a.options.typeahead)
        ) {
        ...
        if (a.options.typeaheadjs) {
          ...
          a.$input.typeahead(null, l).on(
            'typeahead:selected',
            t.proxy(function (t, e) {
              a.add(l.valueKey ? e[l.valueKey] : e),
        ...
        a.$container.on(
          ...
          a.options.addOnBlur &&
            ...
            a.$input.on(
              ...
              t.proxy(function () {
                0 ===
                  t('.typeahead, .twitter-typeahead', a.$container).length &&
                  (a.add(a.$input.val()), a.$input.val(''));
              }, a)
            ),
          a.$container.on(
            'keydown',
          ...
          a.$container.on(
            ...
            t.proxy(function (e) {
              ...
              a.options.freeInput &&
                (o(e, a.options.confirmKeys) || r) &&
                (a.add(r ? i.substr(0, a.options.maxChars) : i),
                n.val(''),
                e.preventDefault());
              var s = n.val().length;
              Math.ceil(s / 5),
          ...
          a.$container.on(
            ...
            '[data-role=remove]',
            t.proxy(function (e) {
              a.$element.attr('disabled') ||
                a.remove(t(e.target).closest('.tag').data('item'));
            }, a)
          ),
          a.options.itemValue === s.itemValue &&
      ...
      findInputWrapper: function () {
        for (
          var e = this.$input[0], n = this.$container[0];
          e && e.parentNode !== n;
