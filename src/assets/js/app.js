...
(function (window, document, $, undefined) {
  $(function () {
    ...
    if ($('#chartjs-doughnutchart').length > 0) {
      var doughnutctx = document
        .getElementById('chartjs-doughnutchart')
        .getContext('2d');
      var doughnutChart = new Chart(doughnutctx).Doughnut(
        doughnutData,
        doughnutOptions
      );
    }
    ...
    if ($('#chartjs-polarchart').length > 0) {
    ...
    if ($('#chartjs-radarchart').length > 0) {
...
(function (window, document, $, undefined) {
  $(function () {
    ...
    function checkLoaderInVIew(element, options) {
      var offset = -20;
      if (
        !element.hasClass(inViewFlagClass) &&
  ...
  $(panelSelector).each(function () {
    ...
    if (!wrapper.length) {
      wrapper = parent
        ...
        .nextAll() //find('.panel-body, .panel-footer')
        .wrapAll('<div/>')
        .parent()
  ...
  $(function () {
    ...
    if (typeof sidebarAnyclickClose !== 'undefined') {
      $('.wrapper').on('click.sidebar', function (e) {
        ...
        var $target = $(e.target);
        if (
          !$target.parents('.aside').length && // if not child of sidebar
...
(function ($, window, doc) {
  ...
  $(function () {
    ...
    var observer = new $.support.mutationobserver(
      $.Utils.debounce(function (mutations) {
...
// Only allow input from numeric characters
