...
(function (a) {
  ...
  var y = function (b, e, d) {
    ...
    var g = this,
      k = b.val(),
      n;
    e = 'function' === typeof e ? e(b.val(), void 0, b, d) : e;
    var c = {
      invalid: [],
      getCaret: function () {
        try {
          var h,
            ...
            a = c.selectionStart;
          if (f && !~navigator.appVersion.indexOf('MSIE 10'))
            (h = f.createRange()),
              h.moveStart(
                'character',
          ...
          if (b.is(':focus')) {
            ...
            a.setSelectionRange
              ...
              : a.createTextRange &&
                ((q = a.createTextRange()),
                q.collapse(!0),
                q.moveEnd('character', h),
                q.moveStart('character', h),
                q.select());
          }
        } catch (f) {}
      },
      events: function () {
        b.on('keyup.mask', c.behaviour)
          ...
          .on('focusout.mask', function () {
            d.clearIfNotMatch && !n.test(c.val()) && c.val('');
          });
      },
      getRegexMask: function () {
        for (var h = [], b, a, f, c, d = 0; d < e.length; d++)
          (b = g.translation[e[d]])
            ? ((a = b.pattern.toString().replace(/.{1}$|^.{1}/g, '')),
              (f = b.optional),
              (b = b.recursive)
                ? (h.push(e[d]), (c = { digit: e[d], pattern: a }))
                : h.push(f || b ? a + '?' : a))
            : h.push(e[d].replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&'));
        h = h.join('');
        c &&
          (h = h
            .replace(RegExp('(' + c.digit + '(.*' + c.digit + ')?)'), '($1)?')
            .replace(RegExp(c.digit, 'g'), c.pattern));
        return RegExp(h);
      },
      ...
      getMCharsBeforeCount: function (a, b) {
        for (var c = 0, f = 0, d = e.length; f < d && f < a; f++)
          g.translation[e.charAt(f)] || ((a = b ? a + 1 : a), c++);
        return c;
      },
      caretPos: function (a, b, d, f) {
        return g.translation[e.charAt(Math.min(a - 1, e.length - 1))]
          ? Math.min(a + d - b - f, d)
          : c.caretPos(a + 1, b, d, f);
      },
      ...
      getMasked: function (a) {
          ...
          if (r)
            v.match(r.pattern)
              ...
              : r.optional
                ? ((f += m), (l -= m))
                : r.fallback
                  ? (b[t](r.fallback), (f += m), (l -= m))
                  : c.invalid.push({ p: l, v: v, e: r.pattern }),
              (l += m);
          else {
            if (!a) b[t](x);
            v === x && (l += m);
        ...
        a = e.charAt(s);
        p !== n + 1 || g.translation[a] || b.push(a);
        return b.join('');
      },
      callbacks: function (a) {
        ...
        p('onChange', !0 === n, f);
        p('onKeyPress', !0 === n, f);
        p('onComplete', g.length === e.length, f);
        p('onInvalid', 0 < c.invalid.length, [g, a, b, c.invalid, d]);
      },
    };
    g.mask = e;
    g.options = d;
    ...
    g.init = function (e) {
      ...
      g.translation = a.extend({}, g.translation, d.translation);
      g = a.extend(!0, {}, g, d);
      n = c.getRegexMask();
      !1 === e
  ...
  var A = function () {
      ...
      if (z(b, d, e)) return b.data('mask', new y(this, d, e));
    },
    z = function (b, e, d) {
      d = d || {};
      b = a(b).data('mask');
      ...
      try {
        return 'object' !== typeof b || g(b.options) !== g(d) || b.mask !== e;
      } catch (k) {}
    };
  a.fn.mask = function (b, e) {
    e = e || {};
    var d = this.selector,
      g = a.jMaskGlobals,
      k = a.jMaskGlobals.watchInterval,
      n = function () {
        if (z(this, b, e)) return a(this).data('mask', new y(this, b, e));
      };
    a(this).each(n);
    d &&
      '' !== d &&
      ...
      (a.maskWatchers[d] = setInterval(function () {
        a(document).find(d).each(n);
      }, k)));
  };
  ...
  k.dataMask && a(k.dataMaskAttr).each(A);
  setInterval(function () {
    a.jMaskGlobals.watchDataMask &&
      a(document)
        .find(a.jMaskGlobals.maskElements)
        .filter(k.dataMaskAttr)
        .each(A);
  }, k.watchInterval);
});
