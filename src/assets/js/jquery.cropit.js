...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root['cropit'] = factory(root['jQuery']);
        ...
        var methods = {
          init: function init(options) {
            return this.each(function () {
              ...
              var cropit = new _cropit2['default'](
                _jquery2['default'],
                this,
                options
              );
          ...
          _createClass(Cropit, [
            {
              ...
              value: function init() {
                ...
                this.image.onerror = this.preImage.onerror = function () {
                  _this.onImageError.call(
                    _this,
                    _constants.ERRORS.IMAGE_FAILED_TO_LOAD
                  );
                };
                ...
                if (this.options.imageBackground) {
                  if (
                    ...
                    [0, 1, 2, 3].forEach(function (i) {
                      _this.imageBgBorderWidthArray[i] =
                        _this.options.imageBackgroundBorderWidth;
                    });
                  }

                  var $previewContainer = this.options.$previewContainer;
                  this.$imageBg = (0, _jquery2['default'])('<img />')
                    .addClass(_constants.CLASS_NAMES.IMAGE_BACKGROUND)
                    .attr('alt', '')
                    .css('position', 'absolute');
                  this.$imageBgContainer = (0, _jquery2['default'])('<div />')
                    .addClass(_constants.CLASS_NAMES.IMAGE_BACKGROUND_CONTAINER)
                    .css({
                      position: 'absolute',
                      zIndex: 0,
                      left:
                        -this.imageBgBorderWidthArray[3] +
                        window.parseInt(
                          this.$preview.css('border-left-width') || 0
                        ),
                      top:
                        -this.imageBgBorderWidthArray[0] +
                        window.parseInt(
                          this.$preview.css('border-top-width') || 0
                        ),
                      width:
                        this.previewSize.w +
                        this.imageBgBorderWidthArray[1] +
                        this.imageBgBorderWidthArray[3],
                      height:
                        this.previewSize.h +
                        this.imageBgBorderWidthArray[0] +
                        this.imageBgBorderWidthArray[2],
                    })
                    .append(this.$imageBg);
                  ...
                  this.$preview.hover(
                    function () {
                      _this.$imageBg.addClass(
                        _constants.CLASS_NAMES.PREVIEW_HOVERED
                      );
                    },
                    function () {
                      _this.$imageBg.removeClass(
                        _constants.CLASS_NAMES.PREVIEW_HOVERED
                      );
                    }
                  );
            ...
            },
            {
              ...
              value: function bindListeners() {
                ...
                this.$preview.on(
                  _constants.EVENTS.PREVIEW,
                  this.onPreviewEvent.bind(this)
                );
                this.$zoomSlider.on(
                  _constants.EVENTS.ZOOM_INPUT,
                  this.onZoomSliderChange.bind(this)
                );
            ...
            },
            {
              ...
              value: function unbindListeners() {
                ...
                this.$preview.off(
                  'dragover.cropit dragleave.cropit drop.cropit'
                );
            ...
            },
            {
              ...
              value: function onDragOver(e) {
                ...
                this.$preview.toggleClass(
                  _constants.CLASS_NAMES.DRAG_HOVERED,
                  e.type === 'dragover'
                );
              },
            },
            ...
            },
            {
              ...
              value: function onPreImageLoaded() {
                if (
                  this.options.smallImage === 'reject' &&
                ...
                if (this.options.allowCrossOrigin) {
                  this.image.crossOrigin =
                    this.preImage.src.indexOf('data:') === 0
                      ? null
                      : 'Anonymous';
                }
            ...
            },
            {
              ...
              value: function setImageLoadingClass() {
                this.$preview
                  .removeClass(_constants.CLASS_NAMES.IMAGE_LOADED)
                  .addClass(_constants.CLASS_NAMES.IMAGE_LOADING);
              },
            },
            {
              ...
              value: function setImageLoadedClass() {
                this.$preview
                  .removeClass(_constants.CLASS_NAMES.IMAGE_LOADING)
                  .addClass(_constants.CLASS_NAMES.IMAGE_LOADED);
              },
            },
            {
            ...
            },
            {
              ...
              value: function onPreviewEvent(e) {
                ...
                if (e.type === 'mousedown' || e.type === 'touchstart') {
                  ...
                  this.$preview.on(
                    _constants.EVENTS.PREVIEW_MOVE,
            ...
            },
            {
              ...
              value: function setOffset(position) {
                if (
                  !position ||
                  !(0, _utils.exists)(position.x) ||
                  !(0, _utils.exists)(position.y)
                ) {
                  return;
                }
            ...
            },
            {
              ...
              value: function setZoom(newZoom) {
                ...
                var updatedWidth = (0, _utils.round)(
                  this.imageSize.w * newZoom
                );
                var updatedHeight = (0, _utils.round)(
                  this.imageSize.h * newZoom
                );
                ...
                if (this.imageLoaded) {
                  ...
                  var newX =
                    this.previewSize.w / 2 -
                    ((this.previewSize.w / 2 - this.offset.x) * newZoom) /
                      oldZoom;
                  var newY =
                    this.previewSize.h / 2 -
                    ((this.previewSize.h / 2 - this.offset.y) * newZoom) /
                      oldZoom;
                ...
                this.$preview.css(
                  'background-size',
                  '' + updatedWidth + 'px ' + updatedHeight + 'px'
                );
                if (this.options.imageBackground) {
                  this.$imageBg.css({
                    width: updatedWidth,
            ...
            },
            {
              ...
              value: function getCroppedImageData(exportOptions) {
                ...
                exportOptions = _jquery2['default'].extend(
                  {},
                  exportDefaults,
                  exportOptions
                );

                var exportZoom = exportOptions.originalSize
                  ? 1 / this.zoom
            ...
            },
            {
              ...
              params: [
                ...
                },
                {
                  ...
                  type: 'number',
                  description:
                    'Error code. `0` means generic image loading failure. `1` means image is too small.',
                },
                {
                  name: 'error.message',
                  type: 'string',
