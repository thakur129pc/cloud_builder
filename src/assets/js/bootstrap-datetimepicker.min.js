  ...
  var a = function (a, n) {
    var r,
      ...
      M = function () {
        ...
        return (
          ...
          e('<div>')
            ...
            .append(e('<table>').addClass('table-condensed').append([t, a, r]))
        );
      },
      T = function () {
        var t = e('<div>')
      ...
      E = function () {
        var t = e('<div>').addClass(
          ...
          a = e('<div>').addClass('datepicker').append(x()),
          r = e('<div>').addClass('timepicker').append(T()),
          ...
          n.sideBySide && D() && k()
            ? (t.addClass('timepicker-sbs'),
              t.append(
                e('<div>')
                  .addClass('row')
                  .append(a.addClass('col-sm-6'))
                  .append(r.addClass('col-sm-6'))
              ),
              t.append(s),
              t)
            : ('top' === n.toolbarPlacement && i.append(s),
              D() &&
                i.append(
                  e('<li>')
                    .addClass(n.collapse && k() ? 'collapse in' : '')
                    .append(a)
                ),
              'default' === n.toolbarPlacement && i.append(s),
              k() &&
                i.append(
                  e('<li>')
                    .addClass(n.collapse && D() ? 'collapse' : '')
                    .append(r)
                ),
              'bottom' === n.toolbarPlacement && i.append(s),
              t.append(i))
        );
      },
      P = function () {
      ...
      S = function () {
        var t,
          ...
          i = n.widgetPositioning.horizontal;
        if (
          (n.widgetParent
          ...
          'auto' === o &&
            (o =
              (f || a).offset().top + m.height() >
                e(window).height() + e(window).scrollTop() &&
              m.height() + a.outerHeight() < (f || a).offset().top
                ? 'top'
                : 'bottom'),
          'auto' === i &&
            (i = t.width() < r.left + m.outerWidth() ? 'right' : 'left'),
          'top' === o
            ? m.addClass('top').removeClass('bottom')
            : m.addClass('bottom').removeClass('top'),
          'right' === i
            ? m.addClass('pull-right')
            : m.removeClass('pull-right'),
      ...
      H = function (e) {
        m &&
          (e && (d = Math.max(h, Math.min(2, d + e))),
          m
            .find('.datepicker > div')
            .hide()
            .filter('.datepicker-' + g[d].clsName)
            .show());
      },
      B = function () {
        var t = e('<tr>'),
      ...
      F = function (e) {
        return n.disabledDates
          ? n.disabledDates[e.format('YYYY-MM-DD')] === !0
          : !1;
      },
      Y = function (e) {
        return n.enabledDates
          ? n.enabledDates[e.format('YYYY-MM-DD')] === !0
          : !1;
      },
      q = function (e, t) {
        return e.isValid()
          ? n.disabledDates && F(e)
            ...
            : n.enabledDates && Y(e)
              ? !0
              : n.minDate && e.isBefore(n.minDate, t)
                ? !1
                : n.maxDate && e.isAfter(n.maxDate, t)
                  ? !1
                  : 'd' === t && -1 !== n.daysOfWeekDisabled.indexOf(e.day())
                    ? !1
                    : !0
          : !1;
      },
      z = function () {
        for (
          var t = [], a = c.clone().startOf('y').hour(12);
          a.isSame(c, 'y');
      ...
      W = function () {
        ...
        t.find('.disabled').removeClass('disabled'),
          q(c.clone().subtract(1, 'y'), 'y') || a.eq(0).addClass('disabled'),
          a.eq(1).text(c.year()),
          q(c.clone().add(1, 'y'), 'y') || a.eq(2).addClass('disabled'),
          n.removeClass('active'),
          l.isSame(c, 'y') && n.eq(l.month()).addClass('active'),
          n.each(function (t) {
      ...
      A = function () {
        var a,
          r,
          o,
          i = m.find('.datepicker-days'),
          s = i.find('th'),
          d = [];
        if (D()) {
          for (
            i.find('.disabled').removeClass('disabled'),
              s.eq(1).text(c.format(n.dayViewHeaderFormat)),
              q(c.clone().subtract(1, 'M'), 'M') ||
                s.eq(0).addClass('disabled'),
              q(c.clone().add(1, 'M'), 'M') || s.eq(2).addClass('disabled'),
              a = c.clone().startOf('M').startOf('week');
            !c.clone().endOf('M').endOf('w').isBefore(a, 'd');
            ...
            0 === a.weekday() &&
              ...
              d.push(r)),
              (o = ''),
              a.isBefore(c, 'M') && (o += ' old'),
              a.isAfter(c, 'M') && (o += ' new'),
              a.isSame(l, 'd') && !u && (o += ' active'),
              q(a, 'd') || (o += ' disabled'),
              a.isSame(t(), 'd') && (o += ' today'),
              (0 === a.day() || 6 === a.day()) && (o += ' weekend'),
              r.append(
      ...
      V = function () {
        var t = m.find('.timepicker-hours table'),
          ...
          r = e('<tr>');
        for (
          c.hour() > 11 && !o && a.hour(12);
          a.isSame(c, 'd') &&
          (o || (c.hour() < 12 && a.hour() < 12) || c.hour() > 11);
      ...
      I = function () {
        for (
          var t = m.find('.timepicker-minutes table'),
            a = c.clone().startOf('h'),
            r = [],
            o = e('<tr>'),
            i = 1 === n.stepping ? 5 : n.stepping;
          c.isSame(a, 'h');

        )
          a.minute() % (4 * i) === 0 && ((o = e('<tr>')), r.push(o)),
            o.append(
      ...
      N = function () {
        for (
          var t = m.find('.timepicker-seconds table'),
            a = c.clone().startOf('m'),
            n = [],
            r = e('<tr>');
          c.isSame(a, 'm');
      ...
      Q = function () {
        ...
        o ||
          m.find('.timepicker [data-action=togglePeriod]').text(l.format('A')),
          e
            .filter('[data-time-component=hours]')
            .text(l.format(o ? 'HH' : 'hh')),
          e.filter('[data-time-component=minutes]').text(l.format('mm')),
          e.filter('[data-time-component=seconds]').text(l.format('ss')),
          V(),
          I(),
          N();
      },
          ...
          ? ((e = e.clone().locale(n.locale)),
            ...
            void (q(e)
              ? ((l = e),
                (c = l.clone()),
                r.val(l.format(i)),
                a.data('date', l.format(i)),
                U(),
                (u = !1),
                j({ type: 'dp.change', date: l.clone(), oldDate: t }))
              : (r.val(u ? '' : l.format(i)),
                j({ type: 'dp.error', date: e }))))
          : ((u = !0),
            r.val(''),
            a.data('date', ''),
            j({ type: 'dp.change', date: null, oldDate: t }),
            void U());
      },
      J = function () {
        var t = !1;
        return m
          ? (m.find('.collapse').each(function () {
      ...
      K = {
        ...
        selectMonth: function (t) {
          ...
          c.month(a),
            d === h && (G(l.clone().year(c.year()).month(c.month())), J()),
            H(-1),
            A();
        },
        ...
        selectHour: function (t) {
          ...
          o || (l.hours() >= 12 ? 12 !== a && (a += 12) : 12 === a && (a = 0)),
            G(l.clone().hours(a)),
            K.showPicker.call(p);
        },
        selectMinute: function (t) {
          G(l.clone().minutes(parseInt(e(t.target).text(), 10))),
            K.showPicker.call(p);
        },
        selectSecond: function (t) {
          G(l.clone().seconds(parseInt(e(t.target).text(), 10))),
            K.showPicker.call(p);
        },
        clear: function () {
          G(null);
      ...
      R = function (t) {
        return e(t.currentTarget).is('.disabled')
          ? !1
          : (K[e(t.currentTarget).data('action')].apply(p, arguments), !1);
      },
      X = function () {
        var a,
          o = {
        ...
        return r.prop('disabled') || r.prop('readonly') || m
          ? p
          : (n.useCurrent &&
              u &&
              ((a = t()),
              'string' == typeof n.useCurrent && (a = o[n.useCurrent](a)),
              G(a)),
            (m = E()),
            B(),
            z(),
      ...
      $ = function (e) {
        return (
          (e =
            t.isMoment(e) || e instanceof Date ? t(e) : t(e, s, n.useStrict)),
          e.locale(n.locale),
          e
        );
      },
      ...
      tt = function () {
        r.on({ change: et, blur: J, keydown: _ }),
          a.is('input')
            ? r.on({ focus: X })
            : f && (f.on('click', Z), f.on('mousedown', !1));
      },
      at = function () {
        r.off({ change: et, blur: J, keydown: _ }),
          a.is('input')
            ? r.off({ focus: X })
            : f && (f.off('click', Z), f.off('mousedown', !1));
      },
      nt = function (t) {
        var a = {};
        return (
      ...
      rt = function () {
        ...
        (i = e.replace(
          ...
          (s = n.extraFormats ? n.extraFormats.slice() : []),
          s.indexOf(e) < 0 && s.indexOf(i) < 0 && s.push(i),
          (o = i.toLowerCase().indexOf('a') < 1 && i.indexOf('h') < 1),
          C('y') && (h = 2),
          C('M') && (h = 1),
          C('d') && (h = 0),
          (d = Math.max(h, d)),
    ...
    if (
      ...
      (p.format = function (e) {
        ...
        if ('string' != typeof e && ('boolean' != typeof e || e !== !1))
          throw new TypeError(
      ...
      (p.maxDate = function (e) {
        ...
        if (n.minDate && t.isBefore(n.minDate))
          throw new TypeError(
            'maxDate() date parameter is before options.minDate: ' + t.format(i)
          );
      ...
      (p.minDate = function (e) {
        ...
        if (n.maxDate && t.isAfter(n.maxDate))
          throw new TypeError(
            'minDate() date parameter is after options.maxDate: ' + t.format(i)
          );
      ...
      (p.defaultDate = function (e) {
        ...
        return (
          (n.defaultDate = t),
          n.defaultDate && '' === r.val().trim() && G(n.defaultDate),
          p
        );
      }),
      (p.locale = function (e) {
      ...
      (p.viewMode = function (e) {
        ...
        if (-1 === y.indexOf(e))
          throw new TypeError(
            'viewMode() parameter must be one of (' + y.join(', ') + ') value'
          );
      ...
      (p.widgetParent = function (t) {
        ...
        if (
          ...
          null !== t && 'string' != typeof t && !(t instanceof jQuery))
        )
          throw new TypeError(
      ...
      r = a;
    else if (((r = a.find('.datepickerinput')), 0 === r.size()))
      r = a.find('input');
    else if (!r.is('input'))
      throw new Error(
    ...
    return (
      ...
      rt(),
      tt(),
      r.prop('disabled') && p.disable(),
      0 !== r.val().trim().length
        ? G($(r.val().trim()))
        : n.defaultDate && G(n.defaultDate),
      p
    );
  };
