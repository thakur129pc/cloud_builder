...
(function () {
  ...
  var _vars = function (options) {
    ...
    if (options.trustedOrigins) {
      if (typeof options.trustedOrigins === 'string') {
        ...
        typeof options.trustedOrigins === 'object' &&
  ...
  var _getSafeZIndex = function (val) {
    ...
    if (!zIndex) {
      if (typeof _defaults.zIndex === 'number' && _defaults.zIndex > 0) {
        ...
        typeof _defaults.zIndex === 'string' &&
        (tmp = parseInt(_defaults.zIndex, 10)) &&
        !isNaN(tmp) &&
        tmp > 0
      ) {
        zIndex = tmp;
  ...
  var _determineScriptAccess = (function () {
    ...
    return function (currentDomain, configOptions) {
      ...
      if (
        typeof allowScriptAccess === 'string' &&
        (asaLower = allowScriptAccess.toLowerCase()) &&
        /^always|samedomain|never$/.test(asaLower)
      ) {
  ...
  ZeroClipboard.prototype.setCurrent = function (element) {
    ...
    var useHandCursor =
      this.options.forceHandCursor === true ||
  ...
  ZeroClipboard.detectFlashSupport = function () {
    var debugEnabled =
      (ZeroClipboard.prototype._singleton &&
        ZeroClipboard.prototype._singleton.options.debug) ||
      _defaults.debug;
