!(function (e) {
  ...
  var t = function (e, i, a) {
      ...
      if (
        ((o.onerror = i),
        (o.onload = function () {
          !r || (a && a.noRevoke) || t.revokeObjectURL(r),
            i && i(t.scale(o, a));
        }),
  ...
  (t.isInstanceOf = function (e, t) {
    ...
    (t.getTransformedOptions = function (e, t) {
      ...
      return (
        ...
        n / r > o
          ? ((i.maxWidth = r * o), (i.maxHeight = r))
          : ((i.maxWidth = n), (i.maxHeight = n / o)),
        i
      );
    }),
    ...
    (t.scale = function (e, i) {
      ...
      return (
        f &&
          ((i = t.getTransformedOptions(e, i)),
          (l = i.left || 0),
          (c = i.top || 0),
          i.sourceWidth
            ? ((s = i.sourceWidth),
              void 0 !== i.right && void 0 === i.left && (l = h - s - i.right))
            : (s = h - l - (i.right || 0)),
          i.sourceHeight
            ? ((d = i.sourceHeight),
              void 0 !== i.bottom && void 0 === i.top && (c = m - d - i.bottom))
            : (d = m - c - (i.bottom || 0)),
          (p = s),
          (S = d)),
        (a = i.maxWidth),
        ...
        f && a && n && i.crop
          ? ((p = a),
            ...
            0 > u
              ? ((d = (n * s) / a),
                void 0 === i.top && void 0 === i.bottom && (c = (m - d) / 2))
              : u > 0 &&
                ((s = (a * d) / n),
                void 0 === i.left && void 0 === i.right && (l = (h - s) / 2)))
          : ((i.contain || i.cover) && ((r = a = a || r), (o = n = n || o)),
            i.cover ? (v(), b()) : (b(), v())),
        f
          ? ((g.width = p),
            (g.height = S),
            t.transformCoordinates(g, i),
            t.renderImageToCanvas(g, e, l, c, s, d, 0, 0, p, S))
          : ((e.width = p), (e.height = S), e)
      );
    }),
        ...
        (e.renderImageToCanvas = function (i, a, n, r, o, s, d, l, c, u) {
          if ('image/jpeg' === a._type) {
            ...
            if (
              ...
              (S.height = b),
              p.save(),
              (g = e.detectSubsampling(a)),
              g && ((n /= 2), (r /= 2), (o /= 2), (s /= 2)),
              (f = e.detectVerticalSquash(a, g)),
              g || 1 !== f)
            ) {
              for (
                r *= f,
                ...
                for (d = 0, h = 0; o > h; )
                  v.clearRect(0, 0, b, b),
                    v.drawImage(a, n, r, o, s, -h, -m, o, s),
                    p.drawImage(S, 0, 0, b, b, d, l, c, u),
                    (h += b),
                    (d += c);
                (m += b), (l += u);
              }
    ...
    (e.hasCanvasOption = function (i) {
      ...
      (e.transformCoordinates = function (t, a) {
        ...
        var n = t.getContext('2d'),
          ...
          s = a.orientation;
        if (s && !(s > 8))
          switch ((s > 4 && ((t.width = o), (t.height = r)), s)) {
            case 2:
              n.translate(r, 0), n.scale(-1, 1);
              break;
            case 3:
              n.translate(r, o), n.rotate(Math.PI);
              break;
            case 4:
            ...
            case 5:
              ...
              break;
            case 6:
              n.rotate(0.5 * Math.PI), n.translate(0, -o);
              break;
            case 7:
              n.rotate(0.5 * Math.PI), n.translate(r, -o), n.scale(-1, 1);
              break;
            case 8:
      ...
      (e.getTransformedOptions = function (t, i) {
        var n,
          ...
          o = a.call(e, t, i),
          s = o.orientation;
        if (!s || s > 8 || 1 === s) return o;
        n = {};
        for (r in o) o.hasOwnProperty(r) && (n[r] = o[r]);
        switch (o.orientation) {
          case 2:
            (n.left = o.right), (n.right = o.left);
            break;
          case 3:
            (n.left = o.right),
              (n.top = o.bottom),
        ...
        return (
          o.orientation > 4 &&
            ((n.maxWidth = o.maxHeight),
            (n.maxHeight = o.maxWidth),
            (n.minWidth = o.minHeight),
            (n.minHeight = o.minWidth),
            (n.sourceWidth = o.sourceHeight),
            (n.sourceHeight = o.sourceWidth)),
          n
        );
      });
  }),
  ...
  (function (e) {
    ...
    (e.ExifMap = function () {
      ...
      (e.getExifValue = function (t, i, a, n, r, o) {
        var s,
          d,
          l,
          c,
      ...
      (e.parseExifTags = function (e, t, i, a, n) {
        ...
        if (
          ((r = e.getUint16(i, a)), (o = i + 2 + 12 * r), o + 4 > e.byteLength)
        )
        ...
        if (!r.disableExif) {
          ...
          if (1165519206 === t.getUint32(i + 4)) {
            ...
            (s = t.getUint32(l + 4, o)),
              ...
              (s = e.parseExifTags(t, l, l + s, o, n)),
              s &&
                !r.disableExifThumbnail &&
                ((d = { exif: {} }),
                (s = e.parseExifTags(t, l, l + s, o, d)),
                d.exif[513] &&
                  (n.exif.Thumbnail = e.getExifThumbnail(
                    t,
                    l + d.exif[513],
                    d.exif[514]
                  ))),
              n.exif[34665] &&
                !r.disableExifSub &&
                e.parseExifTags(t, l, l + n.exif[34665], o, n),
              n.exif[34853] &&
                !r.disableExifGps &&
                e.parseExifTags(t, l, l + n.exif[34853], o, n);
          }
        }
      }),
