  ...
  Accordion.prototype = {
    ...
    init: function () {
      ...
      $accordionHeaders.each(function (index, header) {
        ...
        var isDisabled =
          typeof $header.attr('data-wf-accordion-disabled') !== 'undefined';
        ...
        var headerId =
          'accordion-' + window.wfaccordion.counter + '__header-' + index;
        var panelId =
          'accordion-' + window.wfaccordion.counter + '__panel-' + index;
        ...
        $trigger.on('keydown', function (event) {
          ...
          if (key.match(/38|40/) || ctrlModifier) {
            ...
            $($accordionHeaders[newIndex])
              .find(self.settings.accordionTrigger)
              .focus();
            ...
            switch (key) {
              ...
              case '35':
                $($accordionHeaders[$accordionHeaders.length - 1])
                  .find(self.settings.accordionTrigger)
                  .focus();
                break;
            }
    ...
    enhanceWithButton: function ($placeholder) {
      ...
      if (
        $placeholder.get('0').nodeName &&
        $placeholder.get('0').nodeName.toLowerCase() === 'button'
      ) {
        return $placeholder;
      }

      var $button = $(
        '<button type="button">' + $placeholder.text() + '</button>'
      );
