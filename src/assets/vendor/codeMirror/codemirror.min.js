!(function (e, t) {
  ...
  var e = navigator.userAgent,
    ...
    s =
      !i &&
      /AppleWebKit/.test(e) &&
      (/Mobile\/\w+/.test(e) || 2 < navigator.maxTouchPoints),
    a = /Android/.test(e),
      ...
      function (e, t) {
        ...
        for (var A, O = [], D = 0; D < i; )
          if (de.test(o[D])) {
            ...
            for (var E = H; E < D; )
              if (fe.test(o[E])) {
                H < E && (O.splice(F, 0, new ge(1, H, E)), (F += P));
                var I = E;
                for (++E; E < D && fe.test(o[E]); ++E);
                O.splice(F, 0, new ge(2, I, E)), (F += P), (H = E);
              } else ++E;
            H < D && O.splice(F, 0, new ge(1, H, D));
          }
        return (
          'ltr' == t &&
            (1 == O[0].level &&
              (A = e.match(/^\s+/)) &&
              ((O[0].from = A[0].length), O.unshift(new ge(0, 0, A[0].length))),
            1 == Y(O).level &&
              (A = e.match(/\s+$/)) &&
              ((Y(O).to -= A[0].length),
              O.push(new ge(0, i - A[0].length, i)))),
          'rtl' == t ? O.reverse() : O
        );
      });
  function ge(e, t, n) {
    ...
    ye = function (e, t, n) {
      e.addEventListener
        ...
        : e.attachEvent
          ...
          : ((e = e._handlers || (e._handlers = {}))[t] = (e[t] || ve).concat(
              n
            ));
    };
  function be(e, t) {
  ...
  var Nn,
    An = { left: 0, right: 0, top: 0, bottom: 0 };
  function On(e, t, n) {
  ...
  function Dr(n) {
    n.display.scrollbars &&
      ...
      (n.display.scrollbars = new Or[n.options.scrollbarStyle](
        function (e) {
      ...
      return (
        !window.getSelection ||
          ((t = window.getSelection()).anchorNode &&
            t.extend &&
            A(e.display.lineDiv, t.anchorNode) &&
    ...
    return (
      ...
      (i = l) &&
        ...
        !/^(INPUT|TEXTAREA)$/.test(i.activeElt.nodeName) &&
          i.anchorNode &&
          A(document.body, i.anchorNode) &&
          A(document.body, i.focusNode) &&
        ...
        : h == d
          ? 1 == c.length
            ...
            : ((s = r(1, c.length - 1)).push(
                new Xt(f + h.text.slice(u.ch), p, l)
              ),
  ...
  function Oi(e, t, n, r, i) {
    null == i && (i = e.cm && (e.cm.display.shift || e.extend)),
      Pi(e, new ii([Ai(e.sel.primary(), t, n, i)], 0), r);
  }
  function Di(e, t, n) {
    for (
      ...
      r[o] = Ai(e.sel.ranges[o], t[o], null, i);
  ...
  (ho.prototype = q(no.prototype, {
    ...
    extendSelection: Rr(function (e, t, n) {
      Oi(this, ct(this, e), t && ct(this, t), n);
    }),
  ...
  function Oo(e, t) {
    ...
    return (
      null != n &&
      !e.altGraphKey &&
      (3 == e.keyCode && e.code && (n = e.code), Ao(n, e, t))
    );
  }
  function Do(e) {
          ...
          w && v < 11
            ? Er(r, function (e) {
                ...
                Ce(r, e) ||
                  ...
                  tl(r, e) ||
                  mn(r.display, e) ||
                  (Te(e), (t = r.findWordAt(t)), Oi(r.doc, t.anchor, t.head));
              })
            : function (e) {
                return Ce(r, e) || Te(e);
              }
  ...
  function wl(r, i, o, l, s) {
    var e = i,
      t = o,
      a = $e(r, i.line),
      u = s && 'rtl' == r.direction ? -o : o;
    function n(e) {
      var t, n;
      if (
        null ==
        (t =
          'codepoint' == l
            ? ((t = a.text.charCodeAt(i.ch + (0 < l ? 0 : -1))),
              isNaN(t)
                ? null
                : new rt(
                    i.line,
        ...
        if (
          ...
          (n = i.line + u) < r.first ||
          n >= r.first + r.size ||
          ((i = new rt(n, i.ch, i.sticky)), !(a = $e(r, n)))
        )
          return;
        i = Po(s, r.cm, a, i.line, u);
      } else i = t;
      return 1;
    }
    if ('char' == l || 'codepoint' == l) n();
      ...
      for (
        var c = null,
          h = 'group' == l,
          d = r.cm && r.cm.getHelper(i, 'wordChars'),
          f = !0;
        !(o < 0) || n(!f);
        f = !1
      ) {
        var p = a.text.charAt(i.ch) || '\n',
          p = J(p, d)
            ? 'w'
            : h && '\n' == p
              ? 'n'
              : !h || /\s/.test(p)
                ...
                : 'p';
        if ((!h || f || p || (p = 's'), c && c != p)) {
          o < 0 && ((o = 1), n(), (i.sticky = 'after'));
          break;
        }
        if ((p && (c = p), 0 < o && !n(!f))) break;
      }
    t = Gi(r, i, e, t, !0);
      ...
      if (o.node == r)
        return (function (u, e, t) {
          var n = u.text.firstChild,
            r = !1;
          if (!e || !A(n, e)) return Sl(rt(Je(u.line), 0), !0);
  ...
  (r.prototype.init = function (n) {
    ...
    Ol('lineSeparator', null, function (e, r) {
      if ((e.doc.lineSep = r)) {
        var i = [],
          o = e.doc.first;
        e.doc.iter(function (e) {
    ...
    Ol('rtlMoveVisually', !y),
    Ol('wholeLineUpdateBefore', !0),
    Ol(
      'theme',
      'default',
      function (e) {
    ...
    Ol('keyMap', 'default', function (e, t, n) {
      (t = Do(t)), (n = n != il && Do(n));
      n && n.detach && n.detach(e, t), t.attach && t.attach(e, n || null);
    }),
    Ol('extraKeys', null),
    Ol('configureMouse', null),
    Ol('lineWrapping', !1, al, !0),
    Ol(
      'gutters',
      [],
      function (e, t) {
    ...
    Ol('showCursorWhenSelecting', !1, lr, !0),
    Ol('resetSelectionOnContextMenu', !0),
    Ol('lineWiseCopyCut', !0),
    Ol('pasteLinesPerSelection', !0),
    Ol('selectionsMayTouch', !1),
    Ol('readOnly', !1, function (e, t) {
      'nocursor' == t && (pr(e), e.display.input.blur()),
        e.display.input.readOnlyChanged(t);
    }),
    Ol('screenReaderLabel', null, function (e, t) {
    ...
    Ol('dragDrop', !0, sl),
    Ol('allowDropFileTypes', null),
    Ol('cursorBlinkRate', 530),
    Ol('cursorScrollMargin', 0),
    Ol('cursorHeight', 1, lr, !0),
    Ol('singleCursorHeightPerLine', !0, lr, !0),
    Ol('workTime', 100),
    Ol('workDelay', 100),
    Ol('flattenSpans', !0, fi, !0),
    Ol('addModeClass', !1, fi, !0),
    Ol('pollInterval', 100),
    Ol('undoDepth', 200, function (e, t) {
      return (e.doc.history.undoDepth = t);
    }),
    Ol('historyEventDelay', 1250),
    Ol(
      'viewportMargin',
      10,
      function (e) {
    ...
    Ol('maxHighlightLength', 1e4, fi, !0),
    Ol('moveInputWithCursor', !0, function (e, t) {
      t || e.display.input.resetPosition();
    }),
    Ol('tabindex', null, function (e, t) {
    ...
    (Ml.registerHelper = function (e, t, n) {
      Al.hasOwnProperty(e) || (Al[e] = Ml[e] = { _global: [] }), (Al[e][t] = n);
    }),
    (Ml.registerGlobalHelper = function (e, t, n, r) {
      Ml.registerHelper(e, t, r), Al[e]._global.push({ pred: n, val: r });
    });
  var Dl,
    Wl,
