  ...
  rt.defineMode('javascript', function (e, l) {
    ...
    function x(e, t) {
      ...
      if (
        ...
        return e.skipToEnd(), b('comment', 'comment');
      if (y.test(r))
        return (
    ...
    function z() {
      for (var e = arguments.length - 1; 0 <= e; e--) E.cc.push(arguments[e]);
    }
    function I() {
    ...
    function $(e) {
      ...
      if (((E.marked = 'def'), c)) {
        ...
        l.globalVars &&
          !T(e, t.globalVars) &&
          (t.globalVars = new S(e, t.globalVars));
      }
    }
    function q(e) {
      return (
              ...
              : 'debugger' == e
                ...
                : '{' == e
                  ...
                  : ';' == e
                    ? I()
                    : 'if' == e
                      ? ('else' == E.state.lexical.info &&
                          E.state.cc[E.state.cc.length - 1] == W &&
                          E.state.cc.pop()(),
                        I(U('form'), J, F, W, qe))
                      : 'function' == e
                        ? I(Oe)
                        : 'for' == e
                          ...
                          : 'class' == e || (u && 'interface' == t)
                            ? ((E.marked = 'keyword'),
                              I(U('form', 'class' == e ? e : t), Be, W))
                            : 'variable' == e
                              ? u && 'declare' == t
                                ? ((E.marked = 'keyword'), I(F))
                                : u &&
                                    ('module' == t ||
                                      'enum' == t ||
                                      'type' == t) &&
                                    E.stream.match(/^\s*\w/, !1)
                                  ? ((E.marked = 'keyword'),
                                    'enum' == t
                                      ? I(Ze)
                                      : 'type' == t
                                        ? I(Ne, B('operator'), ke, B(';'))
                                        : I(
                                            U('form'),
                                            Ee,
                                            B('{'),
    ...
    function K(e, t, r) {
      if (E.state.fatArrowAt == E.stream.start) {
        var n = r ? ee : Z;
        if ('(' == e) return I(O, U(')'), se(Ue, ')'), W, B('=>'), n, N);
        if ('variable' == e) return z(O, Ee, B('=>'), n, N);
      }
      var a,
        n = r ? R : Q;
      return M.hasOwnProperty(e)
        ...
        : 'function' == e
          ? I(Oe, n)
          : 'class' == e || (u && 'interface' == t)
            ? ((E.marked = 'keyword'), I(U('form'), We, W))
            : 'keyword c' == e || 'async' == e
              ? I(r ? G : D)
              : '(' == e
                ? I(U(')'), L, B(')'), W, n)
              ...
              ? '(' == e
                ...
                : '.' == e
                  ...
                  : '[' == e
                    ? I(U(']'), L, B(']'), W, n)
                    : u && 'as' == t
                      ? ((E.marked = 'keyword'), I(ke, n))
                      : 'regexp' == e
                        ? ((E.state.lastType = E.marked = 'operator'),
    ...
    function Y(e) {
      if ('}' == e)
        return (E.marked = 'string-2'), (E.state.tokenize = g), I(X);
    }
    function Z(e) {
      return j(E.stream, E.state), z('{' == e ? F : D);
    }
    function ee(e) {
      return j(E.stream, E.state), z('{' == e ? F : G);
    }
    function te(e, t) {
      if ('target' == t) return (E.marked = 'keyword'), I(Q);
    }
    function re(e, t) {
      if ('target' == t) return (E.marked = 'keyword'), I(R);
    }
    function ne(e) {
      return ':' == e ? I(W, F) : z(Q, B(';'), W);
    }
    function ae(e) {
      if ('variable' == e) return (E.marked = 'property'), I();
    }
    function ie(e, t) {
      return 'async' == e
        ? ((E.marked = 'property'), I(ie))
        : 'variable' != e && 'keyword' != E.style
          ? 'number' == e || 'string' == e
            ? ((E.marked = i ? 'property' : E.style + ' property'), I(ce))
            : 'jsonld-keyword' == e
              ? I(ce)
              : u && q(t)
                ? ((E.marked = 'keyword'), I(ie))
                : '[' == e
                  ? I(D, fe, B(']'), ce)
                  : 'spread' == e
                    ? I(G, ce)
          ...
          : ((E.marked = 'property'),
            'get' == t || 'set' == t
              ? I(oe)
              : (u &&
                  E.state.fatArrowAt == E.stream.start &&
                  (r = E.stream.match(/^\s*:\s*/, !1)) &&
                  (E.state.fatArrowAt = E.stream.pos + r[0].length),
                I(ce)));
      var r;
    }
    function oe(e) {
      return 'variable' != e ? z(ce) : ((E.marked = 'property'), I(Oe));
    }
    function ce(e) {
    ...
    function ue(e, t, r) {
      for (var n = 3; n < arguments.length; n++) E.cc.push(arguments[n]);
    ...
    function fe(e, t) {
      if (u) return ':' == e ? I(ke) : '?' == t ? I(fe) : void 0;
    }
    function de(e, t) {
      if (u && (':' == e || 'in' == t)) return I(ke);
    }
    function pe(e) {
      if (u && ':' == e)
    ...
    function me(e, t) {
      if ('is' == t) return (E.marked = 'keyword'), I();
    }
    function ke(e, t) {
      return 'keyof' == t || 'typeof' == t || 'infer' == t || 'readonly' == t
        ? ((E.marked = 'keyword'), I('typeof' == t ? G : ke))
        : 'variable' == e || 'void' == t
          ? ((E.marked = 'type'), I(ge))
          : '|' == t || '&' == t
            ? I(ke)
    ...
    function we(e, t) {
      return 'variable' == e || 'keyword' == E.style
        ? ((E.marked = 'property'), I(we))
        : '?' == t || 'number' == e || 'string' == e
          ? I(we)
          : ':' == e
            ? I(ke)
            : '[' == e
              ? I(B('variable'), de, B(']'), we)
              : '(' == e
                ? z(Pe, we)
                : e.match(/[;\}\)\],]/)
                  ? void 0
    ...
    function xe(e) {
      if ('}' == e)
        return (E.marked = 'string-2'), (E.state.tokenize = g), I(be);
    }
    function he(e, t) {
      return ('variable' == e && E.stream.match(/^\s*[?:]/, !1)) || '?' == t
        ? I(he)
        : ':' == e
          ? I(ke)
          : 'spread' == e
        ...
        : '|' == t || '.' == e || '&' == t
          ...
          : '[' == e
            ...
            : 'extends' == t || 'implements' == t
              ? ((E.marked = 'keyword'), I(ke))
              : '?' == t
                ? I(ke, B(':'), ke)
                : void 0;
    }
    function je(e, t) {
      if ('<' == t) return I(U('>'), se(ke, '>'), W, ge);
    }
    function Me() {
      return z(ke, Ae);
    }
    ...
    function Ve(e, t) {
      return 'enum' == t ? ((E.marked = 'keyword'), I(Ze)) : z(Ee, fe, Te, $e);
    }
    function Ee(e, t) {
      return u && q(t)
        ? ((E.marked = 'keyword'), I(Ee))
        : 'variable' == e
          ? ($(t), I())
          : 'spread' == e
            ? I(Ee)
    ...
    function ze(e, t) {
      return 'variable' != e || E.stream.match(/^\s*:/, !1)
        ? ('variable' == e && (E.marked = 'property'),
          'spread' == e
            ? I(Ee)
            : '}' == e
              ? z()
    ...
    function qe(e, t) {
      if ('keyword b' == e && 'else' == t) return I(U('form', 'else'), F, W);
    }
    function Ce(e, t) {
    ...
    function _e(e, t) {
      return ')' == e
        ...
        : ';' == e
          ? I(_e)
          : 'in' == t || 'of' == t
            ? ((E.marked = 'keyword'), I(D, _e))
            : z(D, _e);
    }
    function Oe(e, t) {
      return '*' == t
        ? ((E.marked = 'keyword'), I(Oe))
        : 'variable' == e
          ? ($(t), I(Oe))
          : '(' == e
            ? I(O, U(')'), se(Ue, ')'), W, pe, F, N)
            : u && '<' == t
              ? I(U('>'), se(Me, '>'), W, Oe)
              : void 0;
    }
    ...
    function Be(e, t) {
      if ('variable' == e) return $(t), I(Fe);
    }
    function Fe(e, t) {
      return '<' == t
        ? I(U('>'), se(Me, '>'), W, Fe)
        : 'extends' == t || 'implements' == t || (u && ',' == e)
          ? ('implements' == t && (E.marked = 'keyword'), I(u ? ke : D, Fe))
          : '{' == e
            ? I(U('}'), He, W)
            : void 0;
    }
    function He(e, t) {
      return 'async' == e ||
        ('variable' == e &&
          ('static' == t || 'get' == t || 'set' == t || (u && q(t))) &&
          E.stream.match(/^\s+[\w$\xa1-\uffff]/, !1))
        ? ((E.marked = 'keyword'), I(He))
        : 'variable' == e || 'keyword' == E.style
          ? ((E.marked = 'property'), I(De, He))
          : 'number' == e || 'string' == e
            ? I(De, He)
            : '[' == e
              ? I(D, fe, B(']'), De, He)
    ...
    function Ge(e, t) {
      return '*' == t
        ? ((E.marked = 'keyword'), I(Xe, B(';')))
        : 'default' == t
          ? ((E.marked = 'keyword'), I(D, B(';')))
          : '{' == e
            ? I(se(Je, '}'), Xe, B(';'))
            : z(F);
    }
    ...
    function Le(e, t) {
      return '{' == e
        ? ue(Le, '}')
        : ('variable' == e && $(t), '*' == t && (E.marked = 'keyword'), I(Re));
    }
    function Qe(e) {
      if (',' == e) return I(Le, Qe);
    }
    function Re(e, t) {
      if ('as' == t) return (E.marked = 'keyword'), I(Le);
    }
    function Xe(e, t) {
      if ('from' == t) return (E.marked = 'keyword'), I(D);
    }
    function Ye(e) {
      return ']' == e ? I() : z(se(G, ']'));
    }
      ...
      (W.lex = N.lex = !0),
      {
        ...
        token: function (e, t) {
          ...
          return 'comment' == k
            ? r
            : ((t.lastType =
                'operator' != k || ('++' != v && '--' != v) ? k : 'incdec'),
              V(t, r, k, v, e));
        },
        indent: function (e, t) {
          if (e.tokenize == h || e.tokenize == g) return rt.Pass;
          ...
          for (
            ...
            a = a.prev;
          var c,
            s = (a = d && ')' == a.type && 'stat' == a.prev.type ? a.prev : a)
              .type,
            u = n == s;
          return 'vardef' == s
            ? a.indented +
