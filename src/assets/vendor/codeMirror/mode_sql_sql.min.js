 ...
 * Original file: /npm/codemirror@5.59.0/mode/sql/sql.js
 *
...
!(function (e) {
  ...
  function t(e) {
    ...
    return (
      e.backUp(e.current().length - 1), e.eatWhile(/\w/) ? 'variable-2' : null
    );
  }
  function r(e) {
    return (
  ...
  e.defineMode('sql', function (t, r) {
    var a = r.client || {},
      s = r.atoms || { false: !0, true: !0, null: !0 },
      l = r.builtin || n(o),
      c = r.keywords || n(i),
      u = r.operatorChars || /^[*+\-%<>!=&|~^\/]/,
      d = r.support || {},
    ...
    function f(e, t) {
      ...
      if ("'" == r || ('"' == r && d.doubleQuote))
        return (t.tokenize = _(r)), t.tokenize(e, t);
      if (
        ((d.nCharCast && ('n' == r || 'N' == r)) ||
      ...
      if (
        (d.commentHash && '#' == r) ||
        ('-' == r && e.eat('-') && (!d.commentSpaceRequired || e.eat(' ')))
      )
        return e.skipToEnd(), 'comment';
      if ('/' == r && e.eat('*')) return (t.tokenize = y(1)), t.tokenize(e, t);
      if ('.' != r) {
...
//# sourceMappingURL=/sm/9b0ca861d51f905f11c60b3b45993d0dddfc7f0574388179f9d040787037fab7.map
