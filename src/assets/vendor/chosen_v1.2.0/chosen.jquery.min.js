  ...
  (i = (function () {
    ...
    return (
      ...
      (t.prototype.add_option = function (t, e, s) {
        return 'OPTION' === t.nodeName.toUpperCase()
          ? ('' !== t.text
    ...
    (e = (function () {
      ...
      return (
          ...
          for (e = '', o = this.results_data, i = 0, r = o.length; r > i; i++)
            (s = o[i]),
              (e += s.group
                ...
                : this.result_add_option(s)),
              (null != t ? t.first : void 0) &&
                (s.selected && this.is_multiple
                  ? this.choice_build(s)
                  : s.selected &&
                    !this.is_multiple &&
                    this.single_set_selected_text(s.text));
          return e;
        }),
        ...
        (t.prototype.result_add_group = function (t) {
          ...
          return (t.search_match || t.group_match) && t.active_options > 0
            ? ((e = document.createElement('li')),
              (e.className = 'group-result'),
              (e.innerHTML = t.search_text),
              this.outerHTML(e))
            : '';
        }),
            ...
            (e = _[c]),
              ...
              this.include_option_in_results(e) &&
                ...
                null != e.group_array_index &&
                  ...
                  0 === r.active_options && r.search_match && (i += 1),
                  (r.active_options += 1)),
                (!e.group || this.group_search) &&
                  ((e.search_text = e.group ? e.label : e.text),
                  (e.search_match = this.search_string_match(e.search_text, s)),
                  e.search_match && !e.group && (i += 1),
                  e.search_match
                    ? (o.length &&
                        ((n = e.search_text.search(l)),
                        (h =
                          e.search_text.substr(0, n + o.length) +
                          '</em>' +
                          e.search_text.substr(n + o.length)),
                        (e.search_text =
                          h.substr(0, n) + '<em>' + h.substr(n))),
        ...
        (t.default_multiple_text = 'Select Options'),
      ...
      chosen: function (i) {
        return e.browser_is_supported()
          ? this.each(function () {
              ...
              (e = t(this)),
                (r = e.data('chosen')),
                'destroy' === i && r instanceof s
                  ? r.destroy()
                  : r instanceof s || e.data('chosen', new s(this, i));
            })
          : this;
      },
    }),
    (s = (function (e) {
      ...
      return (
        ...
        (s.prototype.container_mouseup = function (t) {
          return 'ABBR' !== t.target.nodeName || this.is_disabled
            ? void 0
            : this.results_reset(t);
        }),
        ...
        (s.prototype.test_active_click = function (e) {
          var s;
          return (
            (s = t(e.target).closest('.chosen-container')),
            s.length && this.container[0] === s[0]
              ? (this.active_field = !0)
              : this.close_field()
          );
        }),
        ...
        (s.prototype.set_label_behavior = function () {
          ...
          return (
            ...
            this.form_field_label.length > 0
              ? this.form_field_label.bind('click.chosen', function (t) {
        ...
        (s.prototype.search_results_mouseover = function (e) {
          ...
          return (
            (s = t(e.target).hasClass('active-result')
              ? t(e.target)
              : t(e.target).parents('.active-result').first()),
            s ? this.result_do_highlight(s) : void 0
          );
        }),
        (s.prototype.search_results_mouseout = function (e) {
          return t(e.target).hasClass('active-result')
            ? this.result_clear_highlight()
            : void 0;
        }),
        ...
        (s.prototype.choice_destroy_link_click = function (e) {
          return (
            e.preventDefault(),
            e.stopPropagation(),
            this.is_disabled ? void 0 : this.choice_destroy(t(e.target))
          );
        }),
        ...
        (s.prototype.single_set_selected_text = function (t) {
          return (
            ...
            this.selected_item.find('span').text(t)
          );
        }),
        ...
        (s.prototype.get_search_text = function () {
          return this.search_field.val() === this.default_text
            ? ''
            : t('<div/>').text(t.trim(this.search_field.val())).html();
        }),
        (s.prototype.winnow_results_set_highlight = function () {
          ...
          return (
            ...
            null != t ? this.result_do_highlight(t) : void 0
          );
        }),
