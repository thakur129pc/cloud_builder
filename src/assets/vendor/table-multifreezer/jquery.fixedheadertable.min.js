    ...
    var u = {
      ...
      n = {
        init: function (a) {
          ...
          return this.each(function () {
            var a = c(this);
            h._isTable(a)
              ? (n.setup.apply(this, Array.prototype.slice.call(arguments, 1)),
                c.isFunction(b.create) && b.create.call(this))
              : c.error('Invalid table mark-up');
          });
        },
        setup: function () {
          var a = c(this),
          ...
          f =
            -1 < b.width.search('%')
              ? a.parent().width() - b.scrollbarOffset
              : b.width - b.scrollbarOffset;
          a.css({ width: f });
          a.closest('.fht-table-wrapper').length ||
            (a.addClass('fht-table'),
            a.wrap('<div class="fht-table-wrapper"></div>'));
          f = a.closest('.fht-table-wrapper');
          !0 == b.fixedColumn && 0 >= b.fixedColumns && (b.fixedColumns = 1);
          0 < b.fixedColumns &&
            0 == f.find('.fht-fixed-column').length &&
            (a.wrap('<div class="fht-fixed-body"></div>'),
            c('<div class="fht-fixed-column"></div>').prependTo(f),
            (k = f.find('.fht-fixed-body')));
          f.css({ width: b.width, height: b.height }).addClass(
            b.themeClassName
          );
          a.hasClass('fht-table-init') ||
            a.wrap('<div class="fht-tbody"></div>');
          p = a.closest('.fht-tbody');
          var l = h._getTableProps(a);
          h._setupClone(p, l.tbody);
          a.hasClass('fht-table-init')
            ? (k = f.find('div.fht-thead'))
            : ((k =
                0 < b.fixedColumns
                  ? c(
              ...
              k
                ...
                .addClass(b.originalTable.attr('class'))
                .attr('style', b.originalTable.attr('style')),
              d.clone().appendTo(k.find('table')));
          h._setupClone(k, l.thead);
          a.css({ 'margin-top': -k.outerHeight(!0) });
          !0 == b.footer &&
            (h._setupTableFooter(a, this, l),
      ...
      h = {
          ...
          a.on('scroll', function () {
            0 < b.fixedColumns &&
              d
                ...
                .find('.fht-tbody table')
                .css({ 'margin-top': -a.scrollTop() });
            c.find('table').css({ 'margin-left': -this.scrollLeft });
            (b.footer || b.cloneHeadToFoot) &&
              g.find('table').css({ 'margin-left': -this.scrollLeft });
          });
        },
        _fixHeightWithCss: function (a, d) {
          b.includePadding
            ? a.css({ height: a.height() + d.border })
            : a.css({ height: a.parent().height() + d.border });
        },
        _fixWidthWithCss: function (a, d, e) {
          b.includePadding
            ? a.each(function () {
                c(this).css({ width: void 0 == e ? c(this).width() : e });
              })
            : a.each(function () {
                c(this).css({
        ...
        _setupFixedColumn: function (a, d, e) {
          ...
          t = f
            .find(
              'tbody tr > *:not(:nth-child(n+' + (b.fixedColumns + 1) + '))'
            )
            .each(function (a) {
          ...
          p.appendTo(d).css({ 'margin-top': -1, height: l + e.border });
          t.each(function (a) {
            0 == a % b.fixedColumns &&
              ((s = c('<tr></tr>').appendTo(p.find('tbody'))),
              b.altClass &&
                c(this).parent().hasClass(b.altClass) &&
                s.addClass(b.altClass));
            c(this).clone().appendTo(s);
          });
          d.css({ height: 0, width: r });
          var n =
            d.find('.fht-tbody .fht-table').height() -
            d.find('.fht-tbody').height();
          d.find('.fht-tbody .fht-table').on(
            'mousewheel',
            function (a, d, b, e) {
              if (0 != e)
                return (
                  (a =
                    parseInt(c(this).css('marginTop'), 10) +
                    (0 < e ? 120 : -120)),
                  0 < a && (a = 0),
                  a < -n && (a = -n),
          ...
          if (!0 == b.footer || !0 == b.cloneHeadToFoot)
            (k = f.find('.fht-tfoot tr > *:lt(' + b.fixedColumns + ')')),
              ...
              a.css({ top: b.scrollbarOffset, width: d });
        },
        _setupTableFooter: function (a, d, e) {
            ...
            (a =
              0 < b.fixedColumns
                ? c(
                  ...
                  ).appendTo(d.find('.fht-fixed-body'))
                : c(
                    '<div class="fht-tfoot"><table class="fht-table"></table></div>'
                  ).appendTo(d));
          a.find('table.fht-table').addClass(b.originalTable.attr('class'));
          switch (!0) {
            ...
            case g.length && !1 == b.cloneHeadToFoot && !0 == b.footer:
              a.find('table').append(g).css({ 'margin-top': -e.border }),
                h._setupClone(a, e.tfoot);
          }
        },
        _getTableProps: function (a) {
          var d = { thead: {}, tbody: {}, tfoot: {}, border: 0 },
            c = 1;
          !0 == b.borderCollapse && (c = 2);
          d.border =
            (a.find('th:first-child').outerWidth() -
              a.find('th:first-child').innerWidth()) /
            c;
        ...
        _getColumnsWidth: function (a) {
          ...
          for (k = 0; k < f; k++) b[k] = { rowspan: 1, colspan: 1 };
          a.each(function (a) {
            var l = 0,
              k = 0;
            c(this)
              ...
              .each(function (a) {
                for (
                  var f = parseInt(c(this).attr('colspan')) || 1,
                    h = parseInt(c(this).attr('rowspan')) || 1;
                  1 < b[a + k].rowspan;

                )
                  b[a + k].rowspan--, (k += b[a].colspan);
                a += l + k;
                l += f - 1;
                1 < h && (b[a] = { rowspan: h, colspan: f });
                if ('undefined' === typeof d[a] || 1 != d[a].colspan)
                  (d[a] = {
                    width:
                      c(this).width() +
                      parseInt(c(this).css('border-left-width')) +
                      parseInt(c(this).css('border-right-width')),
                    colspan: f,
                  }),
                    1 == f && g++;
              });
        ...
        _setupClone: function (a, d) {
          ...
          for (i = 0; i < columnsCount; i++) g[i] = { rowspan: 1, colspan: 1 };
          e.each(function (a) {
            var e = 0,
              h = 0;
            c(this)
              ...
              .each(function (a) {
                for (
                  var f = parseInt(c(this).attr('colspan')) || 1,
                    m = parseInt(c(this).attr('rowspan')) || 1;
                  1 < g[a + h].rowspan;

                )
                  g[a + h].rowspan--, (h += g[a].colspan);
                a += e + h;
                e += f - 1;
                1 < m && (g[a] = { rowspan: m, colspan: f });
                'undefined' !== typeof d[a] &&
                  d[a].colspan == f &&
                  ((c(this).find('div.fht-cell').length
                    ? c(this).find('div.fht-cell')
                    : c('<div class="fht-cell"></div>').appendTo(c(this))
                  ).css({ width: parseInt(d[a].width, 10) }),
                  c(this).closest('.fht-tbody').length ||
                    !c(this).is(':last-child') ||
                    c(this).closest('.fht-fixed-column').length ||
                    ((a = Math.max(
                      (c(this).innerWidth() - c(this).width()) / 2,
                      b.scrollbarOffset
                    )),
                    c(this).css({
                      'padding-right':
                        parseInt(c(this).css('padding-right')) + a + 'px',
                    })));
              });
          });
        },
        ...
        _getScrollbarWidth: function () {
          ...
          if (!a)
            if (/msie/.test(navigator.userAgent.toLowerCase())) {
              var b = c('<textarea cols="10" rows="2"></textarea>')
