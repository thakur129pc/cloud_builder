!(function (t) {
  ...
  t.fn.vectorMap = function (t) {
    var s,
      a,
      s = this.children('.jvectormap-container').data('mapObject');
    if ('addMap' === t) jvm.WorldMap.maps[arguments[1]] = arguments[2];
    else {
      if (('set' === t || 'get' === t) && e[t][arguments[1]])
        return (
          (a = arguments[1].charAt(0).toUpperCase() + arguments[1].substr(1)),
          s[t + a].apply(s, Array.prototype.slice.call(arguments, 2))
        );
      (t = t || {}), (t.container = this), (s = new jvm.WorldMap(t));
    }
    return this;
  };
})(jQuery),
  (function (t) {
    function e(e) {
      ...
      return (
        (e = t.event.fix(s)),
        (e.type = 'mousewheel'),
        s.wheelDelta && (i = s.wheelDelta / 120),
        s.detail && (i = -s.detail / 3),
        (r = i),
        void 0 !== s.axis &&
          s.axis === s.HORIZONTAL_AXIS &&
          ((r = 0), (n = -1 * i)),
        void 0 !== s.wheelDeltaY && (r = s.wheelDeltaY / 120),
        void 0 !== s.wheelDeltaX && (n = (-1 * s.wheelDeltaX) / 120),
        a.unshift(e, i, n, r),
    ...
    (t.event.special.mousewheel = {
      setup: function () {
        if (this.addEventListener)
          for (var t = s.length; t; ) this.addEventListener(s[--t], e, !1);
...
var jvm = {
  ...
  mixin: function (t, e) {
    ...
    for (s in e.prototype)
      e.prototype.hasOwnProperty(s) && (t.prototype[s] = e.prototype[s]);
  },
  min: function (t) {
    var e,
      s = Number.MAX_VALUE;
    if (t instanceof Array)
      for (e = 0; e < t.length; e++) t[e] < s && (s = t[e]);
...
(jvm.$ = jQuery),
  ...
  (jvm.AbstractElement.prototype.set = function (t, e) {
    var s;
    if ('object' == typeof t)
      for (s in t) (this.properties[s] = t[s]), this.applyAttr(s, t[s]);
  ...
  (jvm.AbstractCanvasElement.prototype.addPath = function (t, e, s) {
    var a = new jvm[this.classPrefix + 'PathElement'](t, e);
    return this.add(a, s), a;
  }),
  ...
  (jvm.VMLCanvasElement.prototype.setSize = function (t, e) {
    ...
    if (
      ...
      for (
        s = this.rootElement.node.getElementsByTagName('shape'),
          i = 0,
          n = s.length;
        n > i;
        i++
      ...
      for (
        a = this.node.getElementsByTagName('group'), i = 0, n = a.length;
        n > i;
        i++
      )
        (a[i].coordsize = t + ' ' + e),
        ...
        .replace(
          ...
          function (t, n, r) {
            (r = r
              ...
              .split(',')),
              r[0] || r.shift();
            for (var h = 0, o = r.length; o > h; h++)
              r[h] = Math.round(100 * r[h]);
            switch (n) {
              case 'm':
                return (a += r[0]), (i += r[1]), 't' + r.join(',');
              case 'M':
                return (a = r[0]), (i = r[1]), 'm' + r.join(',');
              case 'l':
                return (a += r[0]), (i += r[1]), 'r' + r.join(',');
              case 'L':
                return (a = r[0]), (i = r[1]), 'l' + r.join(',');
              case 'h':
                return (a += r[0]), 'r' + r[0] + ',0';
              case 'H':
                return (a = r[0]), 'l' + a + ',' + i;
              case 'v':
                return (i += r[0]), 'r0,' + r[0];
  ...
  (jvm.VectorCanvas = function (t, e, s) {
    return (
      ...
      (this.impl =
        'svg' == this.mode
          ? new jvm.SVGCanvasElement(t, e, s)
          : new jvm.VMLCanvasElement(t, e, s)),
      this.impl
    );
  }),
  ...
  (jvm.NumericScale.prototype = {
    ...
    getValue: function (t) {
      ...
      for (
        ...
        (e = this.vectorLength(
          ...
          a.push(e),
          (i += e);
      for (s = (this.maxValue - this.minValue) / i, n = 0; n < a.length; n++)
        a[n] *= s;
      for (n = 0, t -= this.minValue; t - a[n] >= 0; ) (t -= a[n]), n++;
      return (t = this.vectorToNum(
        n == this.scale.length - 1
          ? this.scale[n]
          : this.vectorAdd(
              this.scale[n],
    ...
    vectorToNum: function (t) {
      ...
      for (e = 0; e < t.length; e++)
        s += Math.round(t[e]) * Math.pow(256, t.length - e - 1);
      return s;
    },
  ...
  (jvm.ColorScale.arrayToRgb = function (t) {
    ...
    for (s = 0; s < t.length; s++)
      (e = t[s].toString(16)), (a += 1 == e.length ? '0' + e : e);
    return a;
  }),
  ...
  (jvm.DataSeries.prototype = {
    setAttributes: function (t, e) {
      ...
      if ('string' == typeof t)
        ...
        for (s in a)
          this.elements[s] &&
            this.elements[s].element.setStyle(this.params.attribute, a[s]);
    },
    setValues: function (t) {
      ...
      if (
        ...
        for (s in t)
          n[s] = t[s]
            ? this.scale.getValue(t[s])
            : this.elements[s].element.style.initial[this.params.attribute];
      else {
        if (!this.params.min || !this.params.max) {
          for (s in t)
            (e = parseFloat(t[s])), e > a && (a = t[s]), i > e && (i = e);
    ...
    clear: function () {
      ...
      for (t in this.values)
        this.elements[t] &&
          (e[t] =
            this.elements[t].element.style.initial[this.params.attribute]);
  ...
  (jvm.Proj = {
    ...
    aea: function (t, e, s) {
      var a = 0,
        ...
        d = Math.sqrt(m - 2 * l * Math.sin(a)) / l;
      return {
    ...
    lcc: function (t, e, s) {
      var a = 0,
        ...
        o = t * this.radDeg,
        l =
          Math.log(Math.cos(r) * (1 / Math.cos(h))) /
          Math.log(
            Math.tan(Math.PI / 4 + h / 2) * (1 / Math.tan(Math.PI / 4 + r / 2))
          ),
        m = (Math.cos(r) * Math.pow(Math.tan(Math.PI / 4 + r / 2), l)) / l,
        c = m * Math.pow(1 / Math.tan(Math.PI / 4 + o / 2), l),
        p = m * Math.pow(1 / Math.tan(Math.PI / 4 + a / 2), l);
      return {
    ...
    lcc_inv: function (t, e, s) {
      var a = t / this.radius,
        ...
        o = 45 * this.radDeg,
        l =
          Math.log(Math.cos(h) * (1 / Math.cos(o))) /
          Math.log(
            Math.tan(Math.PI / 4 + o / 2) * (1 / Math.tan(Math.PI / 4 + h / 2))
          ),
        m = (Math.cos(h) * Math.pow(Math.tan(Math.PI / 4 + h / 2), l)) / l,
        c = m * Math.pow(1 / Math.tan(Math.PI / 4 + n / 2), l),
        p = this.sgn(l) * Math.sqrt(a * a + (c - i) * (c - i)),
        d = Math.atan(a / (c - i));
      return {
        lat:
          (2 * Math.atan(Math.pow(m / p, 1 / l)) - Math.PI / 2) * this.degRad,
        lng: (r + d / l) * this.degRad,
      };
    },
  }),
  ...
  (jvm.WorldMap.prototype = {
      ...
      this.defaultWidth * this.scale <= this.width
        ? ((t =
          ...
          (s =
            (this.width - this.defaultWidth * this.scale) / (2 * this.scale)))
        : ((t = 0),
          (s = (this.width - this.defaultWidth * this.scale) / this.scale)),
    ...
    bindContainerEvents: function () {
      ...
      this.container
        ...
        .mousedown(function (a) {
          return (s = !0), (t = a.pageX), (e = a.pageY), !1;
        }),
        jvm.$('body').mouseup(function () {
          s = !1;
        }),
        this.params.zoomOnScroll &&
          this.container.mousewheel(function (t, e, s, i) {
            var n = jvm.$(a.container).offset(),
              r = t.pageX - n.left,
              h = t.pageY - n.top,
              o = Math.pow(1.3, i);
            a.label.hide(), a.setScale(a.scale * o, r, h), t.preventDefault();
          });
    },
      ...
      var t,
        ...
        o = function (o) {
          var l,
            ...
            c,
            p,
            d = o.originalEvent.touches;
          'touchstart' == o.type && (r = 0),
            1 == d.length
              ? (1 == r &&
                  ((c = h.transX),
                  (p = h.transY),
                  (h.transX -= (s - d[0].pageX) / h.scale),
                  (h.transY -= (a - d[0].pageY) / h.scale),
                  h.applyTransform(),
                  h.label.hide(),
                  (c != h.transX || p != h.transY) && o.preventDefault()),
                (s = d[0].pageX),
                (a = d[0].pageY))
              : 2 == d.length &&
                (2 == r
    ...
    bindElementEvents: function () {
      ...
      this.container.mousemove(function () {
        ...
        this.container.delegate(
          ...
          'mouseover mouseout',
          function (t) {
            var s = jvm.$(this).attr('class').baseVal
                ? jvm.$(this).attr('class').baseVal
                : jvm.$(this).attr('class'),
              a = -1 === s.indexOf('jvectormap-region') ? 'marker' : 'region',
              i = jvm.$(this).attr('region' == a ? 'data-code' : 'data-index'),
              n = 'region' == a ? e.regions[i].element : e.markers[i].element,
              r =
                'region' == a
                  ? e.mapData.paths[i].name
                  : e.markers[i].config.name || '',
              h = jvm.$.Event(a + 'LabelShow.jvectormap'),
              o = jvm.$.Event(a + 'Over.jvectormap');
            'mouseover' == t.type
              ? (e.container.trigger(o, [i]),
                o.isDefaultPrevented() || n.setHovered(!0),
                e.label.text(r),
                e.container.trigger(h, [e.label, i]),
              ...
              : (n.setHovered(!1),
                e.label.hide(),
                e.container.trigger(a + 'Out.jvectormap', [i]));
          }
        ),
        this.container.delegate(
          "[class~='jvectormap-element']",
        ...
        this.container.delegate(
          ...
          function () {
            var s = jvm.$(this).attr('class').baseVal
              ...
              r = 'region' == a ? e.regions[i].element : e.markers[i].element;
            t ||
              (e.container.trigger(n, [i]),
              (('region' === a && e.params.regionsSelectable) ||
                ('marker' === a && e.params.markersSelectable)) &&
                (n.isDefaultPrevented() ||
                  (e.params[a + 'sSelectableOne'] && e.clearSelected(a + 's'),
    ...
    createLabel: function () {
      ...
      (this.label = jvm
        ...
        this.container.mousemove(function (e) {
          ...
          5 > s && (s = e.pageX + 15),
            5 > a && (a = e.pageY + 15),
            t.label.is(':visible') && t.label.css({ left: s, top: a });
        });
    },
    setScale: function (t, e, s, a) {
      var i,
        n = jvm.$.Event('zoom.jvectormap');
    ...
    setFocus: function (t, e, s) {
      ...
      if (jvm.$.isArray(t) || this.regions[t]) {
        for (r = jvm.$.isArray(t) ? t : [t], h = 0; h < r.length; h++)
          this.regions[r[h]] &&
            ((i = this.regions[r[h]].element.getBBox()),
            i &&
              ('undefined' == typeof a
                ? (a = i)
                : ((n = {
                    ...
                    y: Math.min(a.y, i.y),
                    width:
                      Math.max(a.x + a.width, i.x + i.width) -
                      Math.min(a.x, i.x),
                    height:
                      Math.max(a.y + a.height, i.y + i.height) -
                      Math.min(a.y, i.y),
                  }),
                  (a = n))));
        this.setScale(
          Math.min(this.width / a.width, this.height / a.height),
          -(a.x + a.width / 2),
          -(a.y + a.height / 2),
          !0
        );
    ...
    setSelected: function (t, e) {
      ...
      if (('object' != typeof e && (e = [e]), jvm.$.isArray(e)))
        for (s = 0; s < e.length; s++) this[t][e[s]].element.setSelected(!0);
      ...
      for (t in this.mapData.paths)
        (e = this.canvas.addPath(
          ...
          jvm.$(e.node).bind('selected', function (t, e) {
            s.container.trigger('regionSelected.jvectormap', [
              jvm.$(this).attr('data-code'),
              e,
              s.getSelectedRegions(),
            ]);
          }),
    ...
    createMarkers: function (t) {
      ...
      for (e in t)
        (i = t[e] instanceof Array ? { latLng: t[e] } : t[e]),
          ...
          a !== !1 &&
            ((s = this.canvas.addCircle(
              { 'data-index': e, cx: a.x, cy: a.y },
              jvm.$.extend(!0, {}, this.params.markerStyle, {
                initial: i.style || {},
              }),
              this.markersGroup
            )),
            s.addClass('jvectormap-marker jvectormap-element'),
            jvm.$(s.node).bind('selected', function (t, e) {
            ...
            (this.markers[e] = { element: s, config: i }));
    },
    repositionMarkers: function () {
      var t, e;
      for (t in this.markers)
        (e = this.getMarkerPosition(this.markers[t].config)),
          e !== !1 && this.markers[t].element.setStyle({ cx: e.x, cy: e.y });
    },
    ...
    addMarker: function (t, e, s) {
      var a,
        ...
        r = [],
        s = s || [];
      for (n[t] = e, i = 0; i < s.length; i++)
        (a = {}), (a[t] = s[i]), r.push(a);
      this.addMarkers(n, r);
    },
    addMarkers: function (t, e) {
      var s;
      for (e = e || [], this.createMarkers(t), s = 0; s < e.length; s++)
        this.series.markers[s].setValues(e[s] || {});
    },
    ...
    latLngToPoint: function (t, e) {
      {
        var s,
          a,
          i,
          n = jvm.WorldMap.maps[this.params.map].projection,
          r = n.centralMeridian;
      ...
      return (
        ...
        a
          ? ((i = a.bbox),
            (s.x = ((s.x - i[0].x) / (i[1].x - i[0].x)) * a.width * this.scale),
            (s.y =
              ((s.y - i[0].y) / (i[1].y - i[0].y)) * a.height * this.scale),
            {
    ...
    pointToLatLng: function (t, e) {
      var s,
        ...
        n,
        r,
        h = jvm.WorldMap.maps[this.params.map].projection,
        o = h.centralMeridian,
        l = jvm.WorldMap.maps[this.params.map].insets;
      for (s = 0; s < l.length; s++)
        if (
          ((a = l[s]),
          (i = a.bbox),
          (n = t - (this.transX * this.scale + a.left * this.scale)),
          (r = e - (this.transY * this.scale + a.top * this.scale)),
          (n = (n / (a.width * this.scale)) * (i[1].x - i[0].x) + i[0].x),
          (r = (r / (a.height * this.scale)) * (i[1].y - i[0].y) + i[0].y),
          n > i[0].x && n < i[1].x && r > i[0].y && r < i[1].y)
        )
          return jvm.Proj[h.type + '_inv'](n, -r, o);
      return !1;
    },
    getInsetForPoint: function (t, e) {
      ...
      for (s = 0; s < i.length; s++)
        if (
          ((a = i[s].bbox),
          t > a[0].x && t < a[1].x && e > a[0].y && e < a[1].y)
        )
          return i[s];
    },
