  ...
  function t(t) {
    ...
    return function (r) {
      ...
      n &&
        ...
        this._trigger(t, e.Event(t, { delegatedEvent: r })) !== !1 &&
    ...
    e.widget('blueimp.fileupload', {
        ...
        if (t.lengthComputable) {
          ...
          (i._time = n),
            ...
            (i._progress.bitrate = i.bitrate =
              i._bitrateTimer.getBitrate(n, r, i.bitrateInterval)),
            this._trigger(
              'progress',
      ...
      _initXHRData: function (t) {
        ...
        (t.headers = e.extend({}, t.headers)),
          ...
          (o && !t.blob && this._isInstanceOf('File', n)) ||
            (t.headers['Content-Disposition'] =
              'attachment; filename="' + encodeURI(n.name) + '"'),
          o
            ? e.support.xhrFormDataFileUpload &&
              (t.postMessage
                ? ((i = this._getFormData(t)),
                  t.blob
                    ? i.push({ name: s, value: t.blob })
                ...
                : (r._isInstanceOf('FormData', t.formData)
                    ? (i = t.formData)
                    : ((i = new FormData()),
                  ...
                  t.blob
                    ? i.append(s, t.blob, n.name)
                    : e.each(t.files, function (n, o) {
                        (r._isInstanceOf('File', o) ||
                          r._isInstanceOf('Blob', o)) &&
                          i.append(
                            ('array' === e.type(t.paramName) &&
                              t.paramName[n]) ||
                              s,
      ...
      _getXHRPromise: function (t, i, r) {
        ...
        return (
          ...
          t === !0 ? n.resolveWith(i, r) : t === !1 && n.rejectWith(i, r),
          (o.abort = n.promise),
        ...
        (i.process = function (t, o) {
                ...
                (this._processQueue || n([this]))
                  .pipe(function () {
                    return i.errorThrown
                      ? e.Deferred().rejectWith(r, [i]).promise()
                      : n(arguments);
                  })
                  .pipe(t, o)),
            this._processQueue || n([this])
          ...
          (i.processing = function () {
            return (
              !this.jqXHR &&
              this._processQueue &&
              'pending' === r._getDeferredState(this._processQueue)
            );
          }),
          (i.progress = function () {
      ...
      _chunkedUpload: function (t, i) {
        ...
        var r,
          ...
          d = e.Deferred(),
          h = d.promise();
        return this._isXHRUpload(t) && u && (l || a > p) && !t.data
          ? i
            ? !0
            : l >= a
              ...
              : ((n = function () {
                  ...
                  (i.blob = u.call(s, l, l + p, s.type)),
                    (i.chunkSize = i.blob.size),
                    (i.contentRange =
                      'bytes ' + l + '-' + (l + i.chunkSize - 1) + '/' + a),
                    o._initXHRData(i),
                    o._initProgressListener(i),
                    (r = (
                      (o._trigger('chunksend', null, i) !== !1 && e.ajax(i)) ||
                      o._getXHRPromise(!1, i.context)
                    )
                      .done(function (r, s, p) {
                        (l = o._getUploadedBytes(p) || l + i.chunkSize),
                          h + i.chunkSize - i._progress.loaded &&
                            o._onProgress(
                              e.Event('progress', {
                                lengthComputable: !0,
                          ...
                          a > l ? n() : d.resolveWith(i.context, [r, s, p]);
                      })
                      .fail(function (e, t, r) {
                        (i.jqXHR = e),
                          (i.textStatus = t),
      ...
      _onDone: function (t, i, r, n) {
        var o = n._progress.total,
          s = n._response;
        n._progress.loaded < o &&
          this._onProgress(
            e.Event('progress', { lengthComputable: !0, loaded: o, total: o }),
            n
          ),
          (s.result = n.result = t),
          (s.textStatus = n.textStatus = i),
          (s.jqXHR = n.jqXHR = r),
              ...
              (r =
                ...
                (
                  ((n ||
                    ...
                    a._getXHRPromise(!1, l.context, n)) ||
                  a._chunkedUpload(l) ||
                  e.ajax(l)
                )
                  .done(function (e, t, i) {
                  ...
                  .always(function (e, t, i) {
                    if (
                      ...
                      l.limitConcurrentUploads &&
                        l.limitConcurrentUploads > a._sending)
                    )
        ...
        return (
          ...
          (this.options.limitConcurrentUploads &&
            ...
            ? (this.options.limitConcurrentUploads > 1
                ? ((o = e.Deferred()), this._slots.push(o), (s = o.pipe(p)))
                : ((this._sequence = this._sequence.pipe(p, p)),
                  (s = this._sequence)),
              (s.abort = function () {
                return (
                  (n = [void 0, 'abort', 'abort']),
                  r ? r.abort() : (o && o.rejectWith(l.context, n), p())
                );
              }),
      ...
      _onAdd: function (t, i) {
        var r,
          ...
          m = 0;
        if (
          (!c || (d && void 0 !== u[0].size) || (c = void 0),
          (p.singleFileUploads || h || c) && this._isXHRUpload(p))
        )
        ...
        return (
          (i.originalFiles = u),
          e.each(o || u, function (n, s) {
            var p = e.extend({}, i);
            return (
              (p.files = o ? s : [s]),
              (p.paramName = r[n]),
              a._initResponseObject(p),
              a._initProgressObject(p),
              a._addConvenienceMethods(t, p),
              (l = a._trigger('add', e.Event('add', { delegatedEvent: t }), p))
            );
          }),
          l
        );
      ...
      _handleFileTreeEntry: function (t, i) {
        var r,
          ...
          a = function (e) {
            n._handleFileTreeEntries(e, i + t.name + '/')
              .done(function (e) {
                o.resolve(e);
              })
              .fail(s);
        ...
        return (
          ...
          t.isFile
            ? t._file
              ? ((t._file.relativePath = i), o.resolve(t._file))
              : t.file(function (e) {
      ...
      _getSingleFileInputFiles: function (t) {
        ...
        var i,
          r,
          n = t.prop('webkitEntries') || t.prop('entries');
      ...
      _onPaste: function (t) {
        ...
        i &&
          ...
          this._trigger('paste', e.Event('paste', { delegatedEvent: t }), r) !==
            !1 && this._onAdd(t, r));
      },
      _onDrop: function (t) {
        ...
        r &&
          ...
          r.files.length &&
          (t.preventDefault(),
          this._getDroppedFiles(r).always(function (r) {
            (n.files = r),
              i._trigger('drop', e.Event('drop', { delegatedEvent: t }), n) !==
                !1 && i._onAdd(t, n);
          }));
      },
      ...
      _isRegExpOption: function (t, i) {
        return (
          'url' !== t && 'string' === e.type(i) && /^\/.*\/[igm]{0,3}$/.test(i)
        );
      },
      _initDataAttributes: function () {
        ...
        r.remove(),
          e.each(n, function (e, n) {
            var o =
              'data-' + e.replace(/([a-z])([A-Z])/g, '$1-$2').toLowerCase();
            r.attr(o) &&
          ...
          if (t.fileInput && !t.files) {
            ...
            return (
              (s.abort = function () {
                return (
                  (r = !0),
                  i ? i.abort() : (o.reject(null, 'abort', 'abort'), s)
                );
              }),
              this._getFileInputFiles(t.fileInput).always(function (e) {
                if (!r) {
