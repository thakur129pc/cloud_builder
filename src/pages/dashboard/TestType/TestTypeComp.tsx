                    ...
                    <div className="col-sm-12">
                      ...
                      >
                        ...
                        >
                          ...
                          <tbody>
                            {testTypeList?.map((testType, index) => (
                              <tr
                                key={index}
                                role="row"
                              ...
                              >
                                <td width="20%" className="sorting_1">
                                  <Link
                                    onClick={() => {
                                      dispatch(
                                        updateSelectedTestMachine(testType)
                                      );
                                    }}
                                    to={`/testtypecreate/${testType?.test_type_id}`}
                                  >
                                    {testType.test_type}
                                  </Link>
                                </td>
