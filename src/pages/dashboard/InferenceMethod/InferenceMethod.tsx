...
import { updateSelectedInferenceMethod } from '../../../redux/dashboardSlice';
import { InferenceMethod as MethodList } from '../../../types/DashboardTypes';

const InferenceMethod: React.FC = () => {
                              ...
                              >
                                <td width="20%" className="sorting_1">
                                  <Link
                                    onClick={() => {
                                      dispatch(
                                        updateSelectedInferenceMethod(model)
                                      );
                                    }}
                                    to={`/inferencemethodcreate/${model?.inference_method_id}`}
                                  >
                                    {model?.inference_method_id}
                                  </Link>
                                </td>
                                <td>{model?.name || 'Name not available'}</td>
                              </tr>
                            ))}
                          </tbody>
                        </table>
...
export default InferenceMethod;
