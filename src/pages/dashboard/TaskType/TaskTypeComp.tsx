...
import { updatedSelectedTaskType } from '../../../redux/dashboardSlice';
import { Group } from '../../../types/wizardTypes';

const TaskTypeComp: React.FC = () => {
  ...
  const [taskData, setTaskData] = useState<Group[]>([]);
                            ...
                            {taskData?.map((task, index) => (
                              ...
                              >
                                <td width="20%" className="sorting_1">
                                  <Link
                                    onClick={() => {
                                      dispatch(updatedSelectedTaskType(task));
                                    }}
                                    to={`/tasktypecreate/${task?.group_id}`}
                                  >
                                    {task.group_id}
                                  </Link>
                                </td>
