...
import { updateSelectedCertificate } from '../../../redux/dashboardSlice';
import { ComplianceCertificate } from '../../../types/DashboardTypes';

const CertificateComp: React.FC = () => {
  ...
  useEffect(() => {
    const fetchCertificate = async () => {
      try {
        ...
        const response = await axios.get(API.API_CB + 'certifications');
                              ...
                              >
                                <td width="20%" className="sorting_1">
                                  <Link
                                    onClick={() => {
                                      dispatch(
                                        updateSelectedCertificate(certificate)
                                      );
                                    }}
                                    to={`/certificationcreate/${certificate?.compliance_id}`}
                                  >
                                ...
                                <td>
                                  {certificate.certification_features ||
