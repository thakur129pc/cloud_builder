...
import { Task, TaskGroup } from '../../../types/TaskTypes';
                    ...
                    <div className="row form-group">
                      ...
                      <div className="col-sm-4">
                        <input
                          ...
                          data-parsley-error-message="Enter task name"
                    ...
                    <div className="row form-group">
                      ...
                      <div className="col-sm-4">
                        <select
                          ...
                          name="test_type"
                          disabled={readOnly && !isEditing}
                          value={taskState.task_group_id}
                          onChange={(e) => {
                            setTaskState({
                              ...taskState,
                              task_group_id: Number(e.target.value),
                            });
                          }}
                        >
                    ...
                    <div className="row">
                      <div className="col-sm-12">
                        ...
                        <textarea
                          ...
                          disabled={readOnly && !isEditing}
                          id="description"
                          data-parsley-error-message="Enter task description"
                ...
                >
                  ...
                  <div className="col-sm-12">
                    ...
                    <textarea
                      ...
                      disabled={readOnly && !isEditing}
                      id="description"
                      data-parsley-error-message="Enter option description"
