                        ...
                        >
                          <thead>
                            <tr role="row">
                              ...
                              <th
                                ...
                                rowSpan={1}
                                colSpan={1}
                                aria-label=" Attributes : activate to sort column ascending"
                                style={{ width: '330.625px' }}
                              >
                                {' '}
                                Attributes{' '}
                          ...
                          <tbody>
                            {datasetList?.map((dataset, index) => (
                              ...
                              >
                                <td width="10%" className="sorting_1">
                                  <Link
                                    onClick={() => {
                                      dispatch(
                                        updateSelectedCertificate(dataset)
                                      );
                                    }}
                                    to={`/certificationcreate/${dataset?.data_id}`}
                                  >
                                    {dataset.data_id}
                                  </Link>
                                </td>
